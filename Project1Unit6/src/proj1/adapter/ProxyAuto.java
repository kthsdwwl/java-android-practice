...
public abstract class ProxyAuto {
	...
	/**
	 * Get the auto instance from database according to the name
	 */
	...
	public void updateOptionSetName(String modelName, String setName, String newName) {
		Automobile auto = getModelInstance(modelName);
		if (auto == null)
	...
	/**
	 * Update the option name of an auto instance in the database
	 */
	public void updateOptionName(String modelName, String setName, String optionName, String newName) {
		Automobile auto = getModelInstance(modelName);
		if (auto == null)
			System.out.println("Could not find the model with given name!");
		else {
			auto.updateOption(setName, optionName, newName);
			Database db = new Database();
			db.updateAutomobile(modelName, auto);
		}
	}
	...
	/**
	 * Update the option price of an auto instance in the database
	 */
