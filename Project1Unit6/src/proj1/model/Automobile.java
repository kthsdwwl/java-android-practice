...
public class Automobile implements Serializable{
	...
	public ArrayList<String> getOptionSetList() {
		...
		for (OptionSet item : optionsets) {
			result.add(item.getName());
		}
		return result;
	}
	
	public ArrayList<String> getOptionList(int idx) {
		return optionsets.get(idx).getOptionList();
	}
	
	public ArrayList<Float> getOptionPriceList(int idx) {
		return optionsets.get(idx).getOptionPriceList();
	}
	 ...
	 * @param optionName: the name of option
	 */
	public float findOptionPrice(String setName, String optionName) {
		OptionSet targetSet = findOptionSet(setName);
		if (targetSet == null) {
			return 0;
		}
	...
	/**
	 * Set choice for a specific option 
	 */
	public synchronized boolean setOptionChoice(String setName, String optionName) {
		OptionSet target = findOptionSet(setName);
		if (target == null) {
			...
			return target.setOptionChoice(optionName);
	}
